...
(function (global) {
  ...
  function seed() {
    var t = todayISO();
    var s = {
      meta: { version: 3, seededAt: new Date().toISOString(), today: t },
      ...
      protocols: {
        maria: {
          ...
          treinoHorario: '18:00',
          treino: [
            { n: 'Agachamento livre', metodo: 'reta', rest: 90, sets: [ { reps: '10' }, { reps: '10' }, { reps: '8' }, { reps: '8' } ] },
            { n: 'Supino reto', metodo: 'piramide', rest: 75, sets: [ { reps: '12' }, { reps: '10' }, { reps: '8' }, { reps: '6' } ] },
            { n: 'Cadeira extensora', metodo: 'drop-set', rest: 60, drops: 'após a falha, baixe ~20% do peso e continue (2 quedas, sem descanso)', sets: [ { reps: '12 → falha' }, { reps: '12 → falha' }, { reps: 'até a falha' } ] },
            { n: 'Remada curvada', metodo: 'reta', rest: 60, sets: [ { reps: '10' }, { reps: '10' }, { reps: '10' } ] },
            { n: 'Corrida leve', metodo: 'reta', rest: 0, sets: [ { reps: '20 min contínuo' } ] }
          ],
